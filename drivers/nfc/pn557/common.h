...
#define DTS_IRQ_GPIO_STR		"nxp,irq-gpio"
#define DTS_VEN_GPIO_STR		"nxp,ven-gpio"
#define DTS_FWDN_GPIO_STR		"nxp,firm-gpio"
#define DTS_CLK_GPIO_STR		"nxp,clk-gpio"
...
struct nfc_dev {
	...
	void (*nfc_clk_irq_enable)(struct nfc_dev *dev);
	void (*nfc_clk_irq_disable)(struct nfc_dev *dev);
};
