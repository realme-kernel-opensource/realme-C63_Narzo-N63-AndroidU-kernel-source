...
int sprd_hsphy_set_dpdm_high_impedance_state(void)
{
	...
	ret |= regmap_update_bits(phy->ana_g2,
			 REG_ANLG_PHY_G2_ANALOG_USB20_USB20_BATTER_PLL, msk, 0);
	//#######20240308 Xinhu.Wu add
    msk = MASK_ANLG_PHY_G2_DBG_SEL_ANALOG_USB20_USB20_DPPULLDOWN |
            MASK_ANLG_PHY_G2_DBG_SEL_ANALOG_USB20_USB20_DMPULLDOWN;
    ret |= regmap_update_bits(phy->ana_g2,
        REG_ANLG_PHY_G2_ANALOG_USB20_REG_SEL_CFG_0,
        msk, msk);
	pr_err("20240308 Xinhu debug");
    msk = MASK_ANLG_PHY_G2_ANALOG_USB20_USB20_DPPULLDOWN |
